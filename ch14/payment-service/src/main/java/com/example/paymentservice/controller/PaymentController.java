...
import com.example.paymentservice.vo.RequestPayment;
import com.example.paymentservice.vo.ResponsePayment;
...
public class PaymentController {
    ...
    public ResponseEntity<ResponsePayment> getPayment(@PathVariable("orderId") String orderId) throws Exception {
        ...
        PaymentEntity paymentEntity = paymentService.getPaymentByOrderId(orderId).orElseThrow(() -> null);
